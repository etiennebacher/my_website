...
If you are already familiar with [`lintr`](https://lintr.r-lib.org/), you could think of `flir` as an extension that is faster and applies automatic fixes (at the expense of not covering the entire set of `lintr`'s rules).
