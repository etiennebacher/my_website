...
This would error#calepin.elements.sidenote[Even worse than that, it would #emph[panic]! This is what happens in Rust when you don't properly handle errors.] with Jarl 0.4.0:
