...
#set document(title: [Where should my family meet?])
#metadata((
  title: "Where should my family meet?",
  kind: "post",
  date: "2023-01-14",
  summary: "Or a mathematical way to evade the debate on the location of the next holidays.",
)) <website-metadata>
